...
//#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { {  20, 20 }, { 240,  20 }, { 240, 265 }, { 20, 265 } }
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 200*60, 200*60, 14*60, 10*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
