...
#define STRING_CONFIG_H_AUTHOR "(matt-edmondson)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Frankenstruder"
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
	#define DEFAULT_Kp 29.7025
	#define DEFAULT_Ki 2.7502
	#define DEFAULT_Kd 80.1969
	//M303 E0 S240 C10
	//M301 P29.7025 I2.7502 D80.1969
  #endif
#else
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 254.92
  #define DEFAULT_bedKi 47.56
  #define DEFAULT_bedKd 910.92
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 81.0768, 81.2341, 396.7456, 404.7616 }
// M92 X79.4553 Y79.6095 Z400.7131 E404.7616
/**
 * Default Max Feed Rate (linear=mm/s, rotational=°/s)
 * Override with M203
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 14, 50 }
 ...
 */
//#define Z_MIN_PROBE_PIN PC14 // SKR Mini E3 V3 Zprobe is PC14
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 20, 0, -2.8 }
...
#define X_BED_SIZE 275 // Nozzle is at X0 when homed
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_INSET_LFRB { 25, 5, 5, 5 } // (mm) Left, Front, Right, Back insets
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT X_MAX_POS - 35  // (mm) X point for Z homing
  #define Z_SAFE_HOMING_Y_POINT 0  // (mm) Y point for Z homing
#endif

// Homing speeds (linear=mm/min, rotational=°/min)
#define HOMING_FEEDRATE_MM_M { (300*60), (300*60), (15*60) }
