...
#define STRING_CONFIG_H_AUTHOR "(matt-edmondson, Octopus)" // Original author or contributor.
...
#define CUSTOM_MACHINE_NAME "KatsuBot"
...
#define X2_MIN_ENDSTOP_HIT_STATE LOW
#define X2_MAX_ENDSTOP_HIT_STATE LOW
#define Y2_MIN_ENDSTOP_HIT_STATE LOW
#define Y2_MAX_ENDSTOP_HIT_STATE LOW
...
// 1.8deg/step = 200 steps/rev, 16 microsteps, 2mm pitch leadscrew with 4 starts = 8mm/rev, 200*16/8=400 steps/mm
...
//#define CLASSIC_JERK
  ...
  //#define LIMITED_JERK_EDITING        // Limit edit via M205 or LCD to DEFAULT_aJERK * 2
    ...
    #define MAX_JERK_EDIT_VALUES { 20, 20, 20 } // ...or, set your own edit limits
  #endif
#endif
...
#define X2_ENABLE_ON LOW
#define Y_ENABLE_ON LOW
#define Y2_ENABLE_ON LOW
#define Z_ENABLE_ON LOW
#define Z2_ENABLE_ON LOW
